...
Process each document through the full pipeline with the 66% quality threshold.
...
5. `QualityFilterProcessor` - Filter if corruption >= 66%
...
- Still-corrupt documents (>= 66%): Filtered at QualityFilterProcessor stage
