    ...
    async def test_search_result_structure(self, mcp_server):
        ...
        async with Client(mcp_server) as client:
            ...
            if result.data["total_results"] > 0:
                ...
                # Enhanced search returns multiple score fields
                assert (
                    "semantic_score" in first_result or "combined_score" in first_result
                )
...
class TestAuthorSearch:
    ...
    async def test_search_openalex_author(self, mcp_server):
        ...
        async with Client(mcp_server) as client:
            ...
            # The tool returns a list of papers directly
